function MarkerDetails( _timelineComponent ) 
{
  ...
  {
    if (this.marker) {
      var s = UTILS.getTimeFormatted( Math.round(this.marker.start) ).total;
      var e = UTILS.getTimeFormatted( Math.round(this.marker.end) ).total;
      var l = UTILS.getTimeFormatted( Math.round(this.marker.duration) ).total;
